...
func (jce *johnsonce) Run() (int32, []bool) {
	...
	sccGen := tscc.NewTarjanSCC(jce.graph)
	sccGen.SCC()
...
// |  |v1|v2| ... |vn|
// |  |s1|s2| ... |sk|
func (jce *johnsonce) FindCycles(component *tscc.SCC) ([][]int32, [][]int32, []int32, int32) {
...
func (jce *johnsonce) FindCyclesRecur(component *tscc.SCC, explore []bool, startV, currentV int32, blocked []bool, stack *[]int32, blockedMap *[][]int32, cycles *[][]int32, cyclesMap *[][]int32, sumArray []int32, sum *int32) bool {
	foundCycle := false
...
func (jce *johnsonce) BreakCycles(component *tscc.SCC) []bool {
	invalidVertices := make([]bool, jce.nvertices)
